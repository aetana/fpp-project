package week3.lab10.bst;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

import week3.lab10.employeebst.Employee;
import week3.lab10.employeebst.NameComparator;
...
public class EmployeeBST {
	...
	/** The tree root. */
	private Node root;
	private NameComparator useName;

	//start with an empty tree
	public EmployeeBST(NameComparator compare) {
		root = null;
		this.useName = compare;
	}
	...
	private boolean find(Employee e, Node n){
		...
		if(n != null && n.element.equals(e)) return true;
		return (useName.compare(e, n.element) < 0) ?
				find(e,n.left) :
				find(e,n.right);
	...
	public void insert(Employee e) {
		if (root == null) {
			...
			while(!inserted){
				if(useName.compare(e,n.element)<0) {
				...
				else if(useName.compare(e,n.element) >= 0){ 
